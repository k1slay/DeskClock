...
internal class AddressProviderImpl @Inject constructor(
    ...
    override suspend fun distanceBetween(location: Location, place: Place): Float {
        val loc1 = android.location.Location(location.toString()).apply {
            latitude = location.lat
            longitude = location.lng
        }
        val loc2 = android.location.Location(place.toString()).apply {
    ...
    override suspend fun isPlaceNearby(place: Place?, location: Location): Boolean {
        place ?: return false
